...
'
 from dual where 1=1
 union
 select 499, ' /*+ ALL_ROWS OUTLINE_LEAF(@"SEL$0098CF9D") MERGE(@"SEL$F5B21678") OUTLINE_LEAF(@"SEL$A271CD47") MERGE(@"SEL$FB88E8CF") OUTLINE(@"SEL$3") OUTLINE(@"SEL$F5B21678") MERGE(@"SEL$ABDE6DFF") OUTLINE(@"SEL$1") OUTLINE(@"SEL$FB88E8CF") MERGE(@"SEL$A3DCF13B") MERGE(@"SEL$A422EF13") MERGE(@"SEL$DFD66ADD") MERGE(@"SEL$E3DF9B48") MERGE(@"SEL$E8FDA8C1") OUTLINE(@"SEL$4") OUTLINE(@"SEL$ABDE6DFF") MERGE(@"SEL$6") OUTLINE(@"SEL$2") OUTLINE(@"SEL$A3DCF13B") MERGE(@"SEL$1FB6C052") OUTLINE(@"SEL$A422EF13") MERGE(@"SEL$5EC70623") OUTLINE(@"SEL$DFD66ADD") MERGE(@"SEL$CF5359D5") OUTLINE(@"SEL$E3DF9B48") MERGE(@"SEL$42DFC41A") OUTLINE(@"SEL$E8FDA8C1") MERGE(@"SEL$DC4B4145") OUTLINE(@"SEL$5") OUTLINE(@"SEL$6") OUTLINE(@"SEL$13") OUTLINE(@"SEL$1FB6C052") MERGE(@"SEL$15") OUTLINE(@"SEL$19") OUTLINE(@"SEL$5EC70623") MERGE(@"SEL$21") OUTLINE(@"SEL$7") OUTLINE(@"SEL$CF5359D5") MERGE(@"SEL$9") OUTLINE(@"SEL$10") OUTLINE(@"SEL$42DFC41A") MERGE(@"SEL$12") OUTLINE(@"SEL$16") OUTLINE(@"SEL$DC4B4145") MERGE(@"SEL$18") OUTLINE(@"SEL$14") OUTLINE(@"SEL$15") OUTLINE(@"SEL$20") OUTLINE(@"SEL$21") OUTLINE(@"SEL$8") OUTLINE(@"SEL$9") OUTLINE(@"SEL$11") OUTLINE(@"SEL$12") OUTLINE(@"SEL$17") OUTLINE(@"SEL$18") FULL(@"SEL$A271CD47" "W"@"SEL$9") FULL(@"SEL$A271CD47" "X$KSLED"@"SEL$21") FULL(@"SEL$A271CD47" "E"@"SEL$9") FULL(@"SEL$A271CD47" "S"@"SEL$9") FULL(@"SEL$A271CD47" "X$KGLCURSOR_CHILD"@"SEL$15") FULL(@"SEL$A271CD47" "X$KSWSASTAB"@"SEL$18") FULL(@"SEL$A271CD47" "X$KTCXB"@"SEL$12") LEADING(@"SEL$A271CD47" "W"@"SEL$9" "X$KSLED"@"SEL$21" "E"@"SEL$9" "S"@"SEL$9" "X$KGLCURSOR_CHILD"@"SEL$15" "X$KSWSASTAB"@"SEL$18" "X$KTCXB"@"SEL$12") USE_NL(@"SEL$A271CD47" "X$KSLED"@"SEL$21") USE_NL(@"SEL$A271CD47" "E"@"SEL$9") USE_NL(@"SEL$A271CD47" "S"@"SEL$9") USE_NL(@"SEL$A271CD47" "X$KGLCURSOR_CHILD"@"SEL$15") USE_HASH(@"SEL$A271CD47" "X$KSWSASTAB"@"SEL$18") USE_HASH(@"SEL$A271CD47" "X$KTCXB"@"SEL$12") FULL(@"SEL$0098CF9D" "KS"@"SEL$6") FULL(@"SEL$0098CF9D" "QU"@"SEL$6") FULL(@"SEL$0098CF9D" "KV"@"SEL$6") LEADING(@"SEL$0098CF9D" "KS"@"SEL$6" "QU"@"SEL$6" "KV"@"SEL$6") USE_MERGE_CARTESIAN(@"SEL$0098CF9D" "QU"@"SEL$6") USE_MERGE_CARTESIAN(@"SEL$0098CF9D" "KV"@"SEL$6") */  (SELECT INSTANCE_number FROM V$INSTANCE), ' from dual where 1=1
 union
